...
class HelpCommandCog(discord.Cog):
    ...
    async def guide(self, ctx: Context, channel: discord.TextChannel) -> None:
        ...
        embed.add_field(
            name='● /rate {τίτλος παιχνιδιού} {βαθμολογία κατηγορίας Θέματος} {βαθμολογία κατηγορίας Gameplay} {βαθμολογία κατηγορίας Διασκέδασης} {βαθμολογία κατηγορίας Assets}',
            value='> Αξιολόγησε τα παιχνίδια! Οι βαθμοί πρέπει να είναι δεκαδικοί μεταξύ του 0 και 10.',
            inline=False
        )
        embed.add_field(
            name='● /rated',
            value='> Επιστρέφει όλα τα παιχνίδια που έχεις βαθμολογήσει, μαζί με τους αναλυτικούς βαθμούς που έχεις υποβάλει.',
            inline=False
        )
